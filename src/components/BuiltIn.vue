  ...
  <div class="wrapper">
    <n-space vertical>
      <n-alert title="说明" type="info">
        ...
        <code>CryptoJS.lib.WordArray</code> 格式，这种格式就是
        <code>Uint32Array</code>。
        输入/输出都会根据所选择的编码转换为<code>Uint32Array</code>供下面这些表达式函数使用。
      </n-alert>
      <n-alert title="注意" type="warning">
        表达式的结果必须是
        <code>Uint32Array</code>格式，才能在输出中正确的进行解码
      </n-alert>
    </n-space>
...
const builtins = [
  {
    name: "input",
    kind: "变量",
    sign: "wordArray: Uint32Array",
    description: "输入框的值",
  },
  {
    name: "md5",
    kind: "函数",
    sign: "(wordArray: Uint32Array) => Uint32Array",
